...
export function WhatsAppFloat() {
  return (
    <a
      ...
      className="hidden lg:grid fixed right-5 bottom-5 z-[60] place-items-center rounded-full bg-[#25D366] shadow-[0_8px_24px_rgba(0,0,0,0.25)] transition-transform hover:scale-105"
